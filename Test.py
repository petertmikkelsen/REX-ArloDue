...
def getweightsdist(particles, dist, thetadiff, landmarkid):
    ...
    for i in range(particlenumber):
        weights[i] = max(0.0000000000000000000001, norm(dist, particles[i].getdist(landmark[0], landmark[1]), dist*0.0085))
...
def getweightstheta(particles, thetadiff, landmarkid, oldweights):
    ...
    landmark = landmarklocs[landmarkid]
    for i in range(particlenumber):
        weights[i] = max(0.0000000000000000000001, norm(thetadiff, particles[i].getthetadiff(landmark[0], landmark[1]), 1.6))
